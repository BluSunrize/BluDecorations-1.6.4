	...
	public void initGui()
	{
		...
		else if(particleElements.length>0)
		{
			...
			if(pe!=null)
			{
				...
				this.textField_particlePath = new GuiTextboxAdvanced(this.fontRenderer, x+7, y+130, 176, 11);
			...
			if(pe!=null)
			{
				...
				if(sendPacket)
				{
					...
					for(int i=0; i<elements.length; i++)
						PacketHandler.sendParticleElementPacket(tileEntity.worldObj, tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord, i, elements[i]);
				}
				else
				{
